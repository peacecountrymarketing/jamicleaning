    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="about" className="py-10 md:py-14 bg-navy-gradient text-primary-foreground">
        <div className="container grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="text-xs uppercase tracking-widest font-bold text-accent mb-3 -mt-[50px]">About JAMI</div>
              ...
              <div className="grid md:grid-cols-5">
                ...
                <div className="md:col-span-3 p-8 md:p-10 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-lg md:text-[1.35rem] font-medium leading-relaxed">
